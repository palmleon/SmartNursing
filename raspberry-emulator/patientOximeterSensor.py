...
class Oximeter_sensor():
    ...
    def emulate(self,ID_P):
        ...
        if ID_P==1:
            ...
            self.__baseMessage["e"][3]["v"]= (random.normal(loc=75,scale=2,size= self.__sampleNumber).tolist())
        elif ID_P==2:
            ...
            self.__baseMessage["e"][3]["v"]= (random.normal(loc=52,scale=2,size= self.__sampleNumber).tolist())
        elif ID_P==7:
            ...
            self.__baseMessage["e"][3]["v"]= (random.normal(loc=103,scale=2,size= self.__sampleNumber).tolist())
        elif ID_P==8:
            ...
            self.__baseMessage["e"][3]["v"]= (random.normal(loc=80,scale=6,size= self.__sampleNumber).tolist())
        elif ID_P==9:
